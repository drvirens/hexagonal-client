...
//viren+
DECLARE_bool(disable_log_if_running_unit_tests);
//viren-
...
#define GET_FILE_NAME (strrchr(__FILE__, '/') ? strrchr(__FILE__, '/') + 1 : __FILE__)
//#define LOG_THREAD_ID 0
//#define LOG_DATE_TIME_ID 0
...
#define LOG_INFO if (FLAGS_log_level >= LogLevel_INFO && FLAGS_disable_log_if_running_unit_tests == false) ext_base::LogMessage(GET_FILE_NAME, __LINE__, LOG_PREFIX_INFO).stream()
#define LG LOG_INFO
#define LOG_ERROR if (FLAGS_log_level >= LogLevel_ERROR) ext_base::LogMessage(GET_FILE_NAME, __LINE__, LOG_PREFIX_ERROR).stream()
#define LOG_WARNING if (FLAGS_log_level >= LogLevel_WARNING) ext_base::LogMessage(GET_FILE_NAME, __LINE__, LOG_PREFIX_WARNING).stream()
#define LOG_FATAL if (FLAGS_log_level >= LogLevel_FATAL) ext_base::LogMessage(GET_FILE_NAME, __LINE__, LOG_PREFIX_FATAL).stream()
...
#define CHECK_EQ(a,b) CHECK_EQ_FUN((a),(b), GET_FILE_NAME, __LINE__)
#define CHECK_LT(a,b) CHECK_LT_FUN((a),(b), GET_FILE_NAME, __LINE__)
#define CHECK_LE(a,b) CHECK_LE_FUN((a),(b), GET_FILE_NAME, __LINE__)
#define CHECK_GT(a,b) CHECK_GT_FUN((a),(b), GET_FILE_NAME, __LINE__)
#define CHECK_GE(a,b) CHECK_GE_FUN((a),(b), GET_FILE_NAME, __LINE__)
#define CHECK_NE(a,b) CHECK_NE_FUN((a),(b), GET_FILE_NAME, __LINE__)
...
#define CHECK_STREQ(a,b) CHECK_STREQ_FUN((a),(b), GET_FILE_NAME, __LINE__)
#define CHECK_STRLT(a,b) CHECK_STRLT_FUN((a),(b), GET_FILE_NAME, __LINE__)
#define CHECK_STRGT(a,b) CHECK_STRGT_FUN((a),(b), GET_FILE_NAME, __LINE__)
